exports.up = function (knex) {// logic for transforming into the new state
    return knex.schema
      .createTable("users", (table) => {//User Schema
        table.increments("id");
  ...
  exports.down = function (knex) {// logic for reverting the changes
    return (
      knex.schema
